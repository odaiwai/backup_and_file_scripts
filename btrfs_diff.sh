...
echo "Comparing $SNAPSHOT_NEW vs $SNAPSHOT_OLD..."

echo "Getting the OLD_TRANSID"
OLD_TRANSID=`btrfs subvolume find-new "$SNAPSHOT_OLD" 99999999`
echo "OLD TRANSID: $OLD_TRANSID"
